 ...
 * @version 2020.03.02 15:14:39 // Generated by ComTest
 *
 */
...
public class SpvkTest {
  ...
  // Generated by ComTest BEGIN
  /** testLiikeHistoriaTiedostona125 */
  @Test
  public void testLiikeHistoriaTiedostona125() {    // Spvk: 125
    Spvk spvk = new Spvk(); 
    ...
    assertEquals("From: Spvk line: 140", 51, spvk.liikeHistoriaTiedostona(1).length()); 
    assertEquals("From: Spvk line: 141", 40, spvk.harjsisTiedostona(1).length()); 
  } // Generated by ComTest END
}